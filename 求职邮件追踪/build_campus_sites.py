...
("40","滴滴","网络工程师","北京","未回/无offer","互联网/科技","https://campus.didiglobal.com","2027届8月13日开启；全渠道合计3次投递机会；含安全技术类",""),
...
("78","vivo","网络工程师","东莞","未标注","互联网/科技","https://hr-campus.vivo.com/","⚠️ 2027届网申已于 2026-09-15 12:00 截止，只能看进度，等补录/春招","2026-09-15"),
...
("67","中国人寿","信息技术岗","—","未标注","国企/金融/能源","https://www.chinalife.com.cn/chinalife/zhaopin","2027年度校招已开；总部岗截止 2026-10-15，下辖机构最晚 11-15；最多3个平行志愿","2026-10-15"),
...
def build_md():
    ...
    L.append("> 最后更新：**2026-09-25**　|　数据来源：`WPS云盘/工作计划完成统计表1.xlsx` →「五月」sheet 投递台账　|　共 **{}** 家公司/机构\n".format(len(DATA)))
...
<div class="wrap">
  <header>
    ...
    <div class="sub">
      数据来源：<b>WPS云盘 / 工作计划完成统计表1.xlsx</b> →「五月」sheet 投递台账（115 条记录，去重后 {n_all} 家）<br>
      校招官网均于 2026-09-25 联网核实　|　最后更新：<b>2026-09-25</b>
    </div>
    <div class="stats">
